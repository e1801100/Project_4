...
/**
@brief Stores bme280 calibration data into a structure variable of type  
bme280_comp_param_t.

@param calibReg1: pointer to calibration register 00 - 25.
@param calibReg2: pointer to calibration register 26 - 41.
@param bme: pointer to structure containing compensation parameters.
...
/**
@brief Obtains compensated bme280 temperature and humidity readings.  

@param pSensorData: pointer to bme280_t structure containing temperature  
